...
from modified_ai_economist_gabm.foundation.base.base_agent import agent_registry
from modified_ai_economist_gabm.foundation.base.registrar import Registry
from modified_ai_economist_gabm.foundation.base.world import World
from modified_ai_economist_gabm.foundation.base.base_component import component_registry
from modified_ai_economist_gabm.foundation.entities.endogenous import endogenous_registry
from modified_ai_economist_gabm.foundation.entities.landmarks import landmark_registry
from modified_ai_economist_gabm.foundation.entities.resources import resource_registry
...
class BaseEnvironment(ABC):
    ...
    Example:
        ...
        # see ../scenarios/simple_wood_and_stone_and_iron/vote_and_invest_scenario.py
        UniScenarioClass = foundation.scenarios.get("uniform/simple_wood_and_stone_and_iron")

        # see ../components/move.py and ../components/continuous_double_auction.py and ../components/vote_and_invest_component.py and ../components/build_and_trade_house_vs_skill_component.py
        ...
        BuildTradeComponentClass = foundation.components.get("BuildTradeHouseSkill")
    ...
    Example:
        ...
        env = ScenarioClass(
            components=[
                ...
                ("BuildTradeHouseSkill", {"payment": 10, "payment_max_skill_multiplier": np.array([15, 5])}),
            ],
            n_agents=6,
            world_size=[40, 40],
        )
    ...
    def __init__(
        ...
        self._entities = {
            "resources": ["Coin"],
            "landmarks": [],
            "endogenous": ["Labor", "VoteInvest", "Expertise"],
        }
