...
class BaseAgent:
    ...
    def action_spaces(self):
        ...
        if self.multi_action_mode == True:
            ...
            Example:
                ...
                [5, 7, 8]
                >> self._action_names
                ["Gather", "VoteInvest", "BuildTradeHouseSkill"]
                # [4 Gather actions + Gather NO-OP, 6 VoteInvest actions + VoteInvest NO-OP, 7 BuildTradeHouseSkill actions + BuildTradeHouseSkill NO-OP]
        ...
        if self.multi_action_mode == False:
            ...
            Example:
                ...
                >> self._action_names
                ["Gather", "VoteInvest", "BuildTradeHouseSkill"]
                # 1 NO-OP + 4 Gather actions + 6 VoteInvest actions + 7 BuildTradeHouseSkill actions
        """
    ...
    def endogenous(self):
        ...
        Example:
            >> self.endogenous
            {"Labor": 30.25, "VoteInvest": 50 * [1 / 6, 2 / 6, 3 / 6], "Expertise": ['Expert/Novice']}
        """
    ...
    def inventory(self):
        ...
        Example:
            >> self.inventory
            {"Wood": 3, "Stone": 20, "Iron": 10, "Coin": 1002}
        """
